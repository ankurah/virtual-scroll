...
///
/// The scroll manager wraps `virtual_scroll::ScrollManager` and integrates with
...
///
/// This derive macro is deprecated because it requires virtual-scroll dependency
